  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#1b1c1c] flex flex-col items-center justify-center px-4 py-8 md:py-12">
      ...
      <div className="w-full max-w-md mb-6 flex items-center justify-between">
        <button
          onClick={() => onNavigate('welcome', 'society')}
        ...
        <span className="text-xs font-semibold px-3 py-1 bg-black text-white rounded-full flex items-center gap-1.5 shadow-2xs">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-neutral-900 via-neutral-800 to-black p-6 text-white relative">
          ...
          <h1 className="text-2xl font-black tracking-tight mb-1">Society Staff Sign In</h1>
          <p className="text-xs text-neutral-300">
            Sign in as Guard, Secretary, or Admin to manage vendors and visits.
          </p>
        </div>
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex rounded-xl border border-slate-300 bg-neutral-50 overflow-hidden focus-within:bg-white focus-within:ring-2 focus-within:ring-black focus-within:border-transparent transition-all">
                ...
                <input
                  ...
                  placeholder="9988112345 or email"
            ...
            >
              {isLoading ? (
                ...
                <>
                  <span>Sign In to Society Dashboard</span>
          ...
          <div className="pt-2 text-center text-xs text-neutral-500">
            Need to onboard a new staff member or register?{' '}
            <button
              type="button"
              onClick={() => onNavigate('society_register', 'society')}
              className="text-black font-extrabold hover:underline"
            >
              Register Society Staff
            </button>
          </div>
        </div>
      </div>
