...
export const WorkerLoginView: React.FC<WorkerLoginViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#1b1c1c] flex flex-col items-center justify-center px-4 py-8 md:py-12">
      {/* Header Bar */}
      <div className="w-full max-w-md mb-6 flex items-center justify-between">
        <button
          onClick={() => onNavigate('welcome', 'worker')}
        ...
        <span className="text-xs font-semibold px-3 py-1 bg-emerald-600 text-white rounded-full flex items-center gap-1.5 shadow-2xs">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
        {/* Banner Accent */}
        <div className="bg-gradient-to-r from-slate-900 via-neutral-900 to-slate-950 p-6 text-white relative">
          ...
          <h1 className="text-2xl font-black tracking-tight mb-1">Service Worker Sign In</h1>
          <p className="text-xs text-slate-300">
            Access your job queue, earnings, society service visits, and schedule.
          </p>
        </div>
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <div>
            <button
              ...
              disabled={isLoading}
              className="w-full bg-white hover:bg-neutral-50 text-neutral-800 font-bold py-3 px-4 rounded-xl border border-slate-300 shadow-2xs hover:shadow-md transition-all active:scale-[0.99] flex items-center justify-center gap-3 text-sm"
            >
            ...
            <div className="relative flex items-center justify-center mt-5 mb-1">
              ...
              <span className="bg-white px-3 text-[11px] text-neutral-400 font-bold uppercase tracking-wider absolute">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <span>Sign In to Worker Queue</span>
          ...
          <div className="pt-2 text-center text-xs text-neutral-500">
            Want to register as a Giggs Partner Professional?{' '}
            <button
              type="button"
              onClick={() => onNavigate('worker_register', 'worker')}
